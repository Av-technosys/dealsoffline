        ...
        <div className=' max-w-xl z-10 mx-auto w-full p-3 rounded-xl bg-white flex items-center flex-col gap-4' >
            ...
            <div className=' w-full max-w-xs mx-auto flex flex-col gap-4' >
                <div className=' w-full flex flex-col gap-2' >
                    <div className=' justify-center flex items-center gap-2 text-2xl font-semibold ring-offset-primary-red text-center'>Enter OTP <MessageCircleMore size={22} className=' text-primary-red' /></div>
                    <p className=' text-gray-600  text-center' >A 4 digit code has been sent to you</p>
                </div>
               <InputOTPComponent />
                <Link href={"/vendor-login/thankyou"} className=' w-full py-2 px-4 flex items-center justify-center gap-3 bg-primary-red text-white rounded-md' >
                    <p>Verify OTP</p>
                    <Check size={18} />
                </Link>
                ...
                <p className=' text-sm text-center text-gray-600'>Edit phone number <span className='text-primary-red' >+91-8292085534</span></p>
