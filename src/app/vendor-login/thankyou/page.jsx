...
function SignUp() {
    return (
        <div className=' max-w-xl z-10 mx-auto w-full p-3 rounded-xl bg-white flex items-center flex-col gap-4' >
            <Link href={"/vendor-dashbord"} className=' border border-red-700 py-1.5 px-3 rounded-md w-fit flex items-center gap-2 text-red-700 self-end' >
                <p>Close</p>
                <X size={18} />
            </Link>
            <div className=' w-full max-w-xl mx-auto flex flex-col gap-4' >
                ...
                <div className=' w-full flex flex-col gap-2' >
                    <div className=' justify-center flex items-center gap-2 text-2xl font-semibold text-red-700 text-center'>
                        <p>Congratulations</p>
                ...
                <div className=' w-full py-2 px-4 flex items-center justify-center gap-3 bg-red-700 text-white rounded-md' >
                    <p>Verify OTP</p>
                    <Check size={18} />
                </div> */}
                ...
                <div className=' w-3/5 mx-auto flex gap-4 items-center' >
                    <div className=' h-0.5 w-full bg-red-700 rounded-xl' ></div>
                    <p className=' text-gray-600 whitespace-nowrap shrink-0' >You have Successfully sign up</p>
                    <div className=' h-0.5 w-full bg-red-700 rounded-xl' ></div>
                </div>
                <p className=' text-2xl font-semibold text-center text-red-700'>Set Up Your Profile</p>
