    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <button className=" text-xs shrink-0 text-primary-red font-semibold">show more</button>
            </DialogTrigger>
            <DialogContent showCloseButton={true} className="w-full">
                <DialogHeader>
                    <DialogTitle className=" text-primary-red capitalize" >Others brands</DialogTitle>
