                ...
                <div className=' w-full h-full grid md:grid-cols-2 ' >
                    ...
                    <div className=' w-full h-full p-4 flex flex-col items-center justify-center gap-3' >
                        ...
                        <div className=' max-w-80 flex flex-col mx-auto items-center gap-2' >
                            ...
                            <div onClick={() => { setIsOpen(false); handleNext(true) }} className='cursor-pointer w-full bg-primary-red text-white flex gap-2 items-center justify-center text-center font-semibold py-2 px-3 rounded-md' >
                                <p>Save</p>
                                <Save size={20} />
                            </div>
                        </div>
