            ...
            <DialogContent className={"max-w-5xl w-full max-h-[70vh] overflow-y-auto"} >
                <DialogHeader className={"flex flex-col space-y-1.5 items-center text-center sm:text-left"} >
                    <DialogTitle className=" ml-auto" >
                        <X className=' ml-auto cursor-pointer' size={24} color='#4b5563' onClick={() => { setIsUserProfile(false) }} />
                    </DialogTitle>
                    <div className=' w-full' >
                        ...
                        <div className=' max-w-6xl px-4 mt-6 md:mt-12 mx-auto w-full flex flex-col gap-4' >
                            ...
                            <div className=' flex flex-col h-full gap-16 md:gap-20 md:flex-row ' >
                                ...
                                <div className=" flex flex-col text-left gap-3 md:gap-12" >
